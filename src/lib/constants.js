...
Suggest UP TO 5 alternative exercises, ordered best-first by relevance and effectiveness, that each satisfy:
...
Make the 5 genuinely diverse — different equipment, angles, and sub-patterns within the same muscle group — not 5 near-identical variations of one idea. If the user message lists exercises already shown in a previous batch, treat that as a hard constraint: don't repeat any of them or offer a close variant of one (e.g. don't include "Weighted Plank" if "Plank" was already shown).
BE TERSE — this is a short list, not a set of essays. "note" is a single short form cue, 8 words max. "reason" is one short phrase, 12 words max. No filler, no restating the exercise name, no multi-clause sentences.
